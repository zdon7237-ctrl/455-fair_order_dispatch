...
- Revenue test: `p = 0.0141`, significant at 5%
- PPO shock Gini: `0.0835 +/- 0.0109`
- Local-First shock Gini: `0.1104 +/- 0.0165`
- Gini test: `p = 0.00045`, significant at 5%

The cautious conclusion is that PPO improves fairness in this simulator, but the 10-seed run also shows a statistically clear revenue cost relative to `Local-First`. The result is best read as an efficiency-fairness trade-off rather than an unqualified improvement.
